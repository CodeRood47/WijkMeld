        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewPrio = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatusUpdates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StatusUpdates_Incidents_IncidentId",
                        column: x => x.IncidentId,
                        principalTable: "Incidents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StatusUpdates_Users_ChangedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusUpdates_ChangedById",
                table: "StatusUpdates",
                column: "ChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_StatusUpdates_IncidentId",
                table: "StatusUpdates",
                column: "IncidentId");
        }
